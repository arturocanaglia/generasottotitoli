#https://it.linux-console.net/?p=31090
...
def add_subtitle_to_video(soft_subtitle, subtitle_file,  subtitle_language):
    ...
    if soft_subtitle:
        stream = ffmpeg.output( video_input_stream,
...
def run():
    ...
    add_subtitle_to_video(soft_subtitle=True, subtitle_file=subtitle_file, subtitle_language=language)
